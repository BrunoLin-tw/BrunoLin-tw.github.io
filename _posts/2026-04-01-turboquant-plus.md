...
# 這位老兄把 TurboQuant 實現還加強了 - TurboQuant+
...
## 優缺點直球對決
**Pro**：
- 壓縮牛，長 ctx 記憶體殺手（128K 74GB）。
- 速度不鳥（prefill 1.1x q8_0）。
- 配置指南細（[turboquant-recommendations.md](https://github.com/TheTom/turboquant_plus/blob/main/docs/turboquant-recommendations.md)），**Apache-2.0** 隨便 hack。
...
**結論**：**有興趣玩得可以試試**。從 asymmetric turbo4 開始，測 PPL / tok/s。看看能省多少顯卡記憶體。
...
有興趣的 engineering 兄弟，動手啊！💪

（2026/04/01，Bruno Lin）
